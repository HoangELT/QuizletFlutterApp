      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          onPressed: () {
            ...
            for (CardModel card in listCard) {
              print('Thuật ngữ: ${card.term}, Định nghĩa: ${card.define}');
            }
          },
          ...
          TextButton(
            onPressed: () async {
              try {
                                ...
                                child: Center(
                                  child: CustomText(
                                    ...
                                    style: const TextStyle(
                                      fontWeight: FontWeight.w400,
                                      color: Color.fromARGB(255, 249, 15, 11),
                                      fontSize: 20,
                                    ),
                                  ),
                                ),
                  ...
                  if (code != null) {
                    if (code == 0) {
                      ...
                      var isDelete = await showDialog(
                        ...
                        builder: (context) {
                          return AlertDialog(
                            backgroundColor: Color.fromARGB(159, 33, 38, 40),
                ...
                print('Lỗi lưu topic vào database');
              }
            },
            child: CustomText(
              text: 'Xong',
